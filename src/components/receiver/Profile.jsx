...
const Profile = () => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      const formattedProfile = {
        ...
        bio: userData.bio || '',
        receiverType: userData.receiver?.receiverType || 'personal',
        preferences: {
          emailNotifications: true,
          smsNotifications: false,
          donationAlerts: true,
  ...
  const getReceiverTypeDisplay = () => {
    if (profile.receiverType === 'organization') {
      return (
    ...
    return (
      <span className="flex items-center">
        <FaUserCircle className="mr-1" /> Individual
      </span>
    );
  };
    ...
    <ReceiverLayout>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          {/* Right Column - Profile Summary & Preferences */}
            ...
            <div className="bg-gradient-to-br from-teal-50 to-indigo-50 rounded-xl p-6 border border-teal-200">
              <div className="text-center mb-6">
                <div className="w-24 h-24 bg-teal-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-teal-600 font-bold text-3xl">{getInitials()}</span>
                </div>
                <h3 className="text-xl font-bold text-gray-800">{profile.name || 'Receiver'}</h3>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-indigo-600">
                    {profile.receiverType === 'organization' ? 'Organization' : 'Individual'}
                  </span>
                </div>
              </div>
            </div>
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">
                        {key.includes('email') ? 'Receive email notifications' :
                         ...
                         key.includes('donation') ? 'Get donation alerts' :
