...
const ReceiverLayout = ({ children }) => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">Loading receiver dashboard...</p>
        </div>
      </div>
    );
  }
  ...
  const getReceiverTypeDisplay = () => {
    if (user.receiver?.receiverType === 'organization') {
      return (
          ...
          <div className="px-4 py-4 flex justify-between items-center">
            <div className="lg:hidden">
              <div className="flex items-center space-x-2">
                ...
                <h1 className="font-bold text-gray-800">Receiver Portal</h1>
              </div>
            </div>
