...
const DonorLayout = ({ children, activePage }) => {
  const navItems = [
          ...
          <div className="px-4 py-4 flex justify-between items-center">
            <div className="lg:hidden">
              <div className="flex items-center space-x-2">
                ...
                <h1 className="font-bold text-gray-800">Donor</h1>
              </div>
            </div>
            <div className="hidden lg:block">
              <h1 className="text-2xl font-bold text-gray-800">Welcome back, <span className="text-teal-600">Michael</span>!</h1>
