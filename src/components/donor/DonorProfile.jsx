...
const DonorProfile = () => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      const formattedProfile = {
        ...
        bio: userData.bio || '',
        donorType: userData.donor?.donorType || 'personal',
        preferences: {
          emailNotifications: true,
          smsNotifications: false,
          requestAlerts: true,
  ...
  const getDonorTypeDisplay = () => {
    if (profile.donorType === 'organization') {
      return (
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-teal-50 to-indigo-50 rounded-xl p-6 border border-teal-200">
              <div className="text-center mb-6">
                ...
                <h3 className="text-xl font-bold text-gray-800">{profile.name || 'Donor'}</h3>
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-indigo-600">
                    {profile.donorType === 'organization' ? 'Organization' : 'Individual'}
                  </span>
                </div>
              </div>
            </div>
